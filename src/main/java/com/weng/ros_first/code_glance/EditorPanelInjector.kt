package com.weng.ros_first.code_glance
...
import com.weng.ros_first.code_glance.config.Config
...
class EditorPanelInjector(private val project: Project) : FileEditorManagerListener {
     ...
     *
     * We are digging way down into the editor layout. This lets the code_glance panel be right next to the scroll bar.
