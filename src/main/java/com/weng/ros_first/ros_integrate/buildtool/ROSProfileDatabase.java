package com.weng.ros_first.ros_integrate.buildtool;
...
public class ROSProfileDatabase implements PersistentStateComponent<ROSProfileDatabase.State> {
    ...
    private static final Logger LOG = Logger.getInstance("#com.weng.ros_first.ros_integrate.buildtool.ROSProfileDatabase");
    @NotNull
