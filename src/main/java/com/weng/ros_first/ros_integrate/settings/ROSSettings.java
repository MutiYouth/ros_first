package com.weng.ros_first.ros_integrate.settings;
...
import com.weng.ros_first.ros_integrate.ui.PathListUtil;
...
public class ROSSettings implements PersistentStateComponent<ROSSettings.State> {
    private static final Logger LOG = Logger.getLogger("#com.weng.ros_first.ros_integrate.settings.ROSSettings");
     ...
     *                        See {@link com.weng.ros_first.ros_integrate.pkg.xml.ROSLicenses.LicenseEntity#getLink(String)} for details
     */
