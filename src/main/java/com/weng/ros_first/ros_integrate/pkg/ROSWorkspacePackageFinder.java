...
import com.weng.ros_first.ros_integrate.pkg.psi.impl.ROSSourcePackage;
...
public class ROSWorkspacePackageFinder extends ROSPackageFinderBase {
    private static final Logger LOG = Logger.getInstance("#com.weng.ros_first.ros_integrate.workspace.ROSWorkspacePackageFinder");
