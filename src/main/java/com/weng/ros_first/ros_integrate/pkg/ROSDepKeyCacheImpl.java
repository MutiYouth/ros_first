...
import com.weng.ros_first.ros_integrate.pkg.psi.impl.ROSDepKey;
import com.weng.ros_first.ros_integrate.settings.ROSSettings;
import com.weng.ros_first.ros_integrate.ui.HistoryKey;
...
public class ROSDepKeyCacheImpl implements ROSDepKeyCache {
    private static final Logger LOG = Logger.getLogger("#com.weng.ros_first.ros_integrate.pkg.ROSDepKeyCacheImpl");
