...
import com.weng.ros_first.ros_integrate.pkg.xml.ui.NewLicenseDialogue;
...
public class AddLicenseFileFix implements LocalQuickFix {
    private static final Logger LOG = Logger.getLogger("#com.weng.ros_first.ros_integrate.pkg.xml.intention.AddLicenseFileFix");
