package com.weng.ros_first.ros_integrate.pkg.psi.impl;
...
public abstract class ROSPackageBase extends PsiElementBase implements ROSPackage, Queryable {
    private static final Logger LOG = Logger.getInstance("#com.weng.ros_first.ros_integrate.workspace.ROSPackageBase");
