package com.weng.ros_first.ros_integrate.pkg;
...
import com.weng.ros_first.ros_integrate.pkg.psi.impl.ROSCompiledPackage;

import java.util.*;
import java.util.function.BiPredicate;

import static com.weng.ros_first.ros_integrate.pkg.psi.impl.ROSCompiledPackage.RootType;
...
public class ROSCompiledPackageFinder extends ROSPackageFinderBase {
    private static final Logger LOG = Logger.getInstance("#com.weng.ros_first.ros_integrate.workspace.ROSCompiledPackageFinder");
